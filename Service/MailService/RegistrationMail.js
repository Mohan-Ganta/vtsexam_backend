...
const sendLoginCredentialsMail = async (email,assesmentLink) => {
  ...
  <div style="margin-bottom:20px;">
    ...
    <ul style="list-style-type:none;padding:0;">
      <li style="background:#f9f9f9;margin:5px 0;padding:6px;border-radius:5px;">• ARITHMETIC – 30 Questions</li>
      <li style="background:#f9f9f9;margin:5px 0;padding:6px;border-radius:5px;">• LOGICAL – 15 Questions</li>
      <li style="background:#f9f9f9;margin:5px 0;padding:6px;border-radius:5px;">• VERBAL – 15 Questions</li>
    </ul>
